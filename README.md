...
In an attempt to create a secure, fast, open, decentralized consensus algorithm, Chia is hosting a 3-month competition for the implementation of verifiable delay functions.  Below, we provide links to relevant research papers and resources and a summary of the competition requirements.
